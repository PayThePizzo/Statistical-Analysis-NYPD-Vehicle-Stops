...
```{r load-data}
vehstop <- read.csv("data/vehiclestops_4_wheels.csv")
```
...
or_tbl <- tidy(mod_base, conf.int = TRUE, conf.method = "wald", exponentiate = TRUE) %>%
...
```{r logit-influence, fig.width=10, fig.height=8}
